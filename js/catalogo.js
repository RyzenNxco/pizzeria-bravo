...
window.CATALOGO = (() => {
  ...
  const PIZZAS = [
    { id: 'muzzarella',   name: 'Muzzarella',                 price: 15000, ok: true, tone: 'muzza',   badge: 'La clásica',        desc: 'Salsa de tomate, muzzarella, aceitunas y orégano.' },
    { id: 'jamon',        name: 'Jamón',                      price: 17000, ok: true, tone: 'jamon',                                desc: 'Muzzarella y jamón cocido.' },
    { id: 'jamon-morron', name: 'Jamón con morrones',         price: 18000, ok: true, tone: 'jymor',   badge: 'La más pedida',     desc: 'Muzzarella, jamón cocido y morrones asados.' },
